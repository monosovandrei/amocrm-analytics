...
const cases = [
  ...
  { name:'agreement-confirmed', check:'deadline_agreement', stage:'КП презентовано', texts:[['manager_note','manager','Клиент попросил перенести звонок на 30.09.2026, потому что уезжает в командировку.'],['customer_message','customer','Согласен перенести наш звонок на 30.09.2026.']], expected:['present','present','present'] },
  { name:'note-exact-newline', check:'proposal_note', stage:'КП подготовлено', texts:[['manager_note','manager','Сегодня  клиент на встречах, поэтому не смогли презентовать КП.\nПрезентация перенесена на 23.09.2026 в 15:00.']], expected:['present','present'] },
